...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(hub.channel.ChannelNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleChannelNotFoundException(
            hub.channel.ChannelNotFoundException e) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(errorBody(HttpStatus.NOT_FOUND, e.getMessage()));
    }

    @ExceptionHandler(hub.channel.ChannelConflictException.class)
    public ResponseEntity<Map<String, Object>> handleChannelConflictException(
            hub.channel.ChannelConflictException e) {
