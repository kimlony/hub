...
class CollectScheduleClaimSqlIntegrationTest {
    ...
    /**
     * 실행 시각이 지난 활성 스케줄을 선점하고 실행 중으로 변경하는지 검증한다.
     */
    @Test
    ...
    /**
     * 실행 시각이 오지 않은 스케줄을 선점하지 않는지 검증한다.
     */
    @Test
    ...
    /**
     * 최근 실행 중으로 변경된 스케줄을 다시 선점하지 않는지 검증한다.
     */
    @Test
    ...
    /**
     * 장시간 멈춘 실행 중 스케줄을 다시 선점하는지 검증한다.
     */
    @Test
    ...
    /**
     * 선점 개수 제한을 지키고 같은 스케줄을 중복 선점하지 않는지 검증한다.
     */
    @Test
